...
use core::{
    evaluate_mesh_graph, AttributeDomain, AttributeInfo, AttributeType, Mesh, MeshEvalState,
    Project, SceneSnapshot, ShadingMode,
};
use eframe::egui;
use render::{
...
impl GraphoApp {
    ...
    fn show_node_info_panel(&mut self, ctx: &egui::Context) {
